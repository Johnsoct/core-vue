<script setup lang="ts">
  ...
  import BaseInvoiceTag from '@src/components/base/base-invoice-tag.vue';
  import BaseModal from '@src/components/base/base-modal.vue';
  import BaseRadioInput from '@src/components/base/base-radio-input.vue';
  import BaseReservesTag from '@src/components/base/base-reserves-tag.vue';
  import BaseSelect from '@src/components/base/base-select.vue';
  import BaseTransfersTag from '@src/components/base/base-transfers-tag.vue';
  ...
  const tooltips: { position: string, text: string }[] = [
    {
      position: 'bottom',
  ...
  <main class="Styleguide">
    ...
    <div class="Styleguide__section">
      ...
      <section>
        ...
        >
          <label class="Styleguide__color-category-header mr-8">{{ colorsTypes[colorsBGsIndex] }}</label>
    ...
    <div class="Styleguide__section">
      ...
      <section>
        ...
        <div class="Styleguide__spacing-table">
          ...
          >
            <label class="Styleguide__spacing-table-column">{{ spacing.name }}</label>
            <label class="Styleguide__spacing-table-column">{{ spacing.rem }}rem</label>
            <label class="Styleguide__spacing-table-column">{{ spacing.px }}px</label>
      ...
      <section>
        ...
        <div class="Styleguide__spacing-table">
          <div
            ...
            class="Styleguide__spacing-table-row"
          >
            <label class="Styleguide__spacing-table-column">{{ container.name }}</label>
            <label class="Styleguide__spacing-table-column">{{ container.rem }}rem</label>
            <label class="Styleguide__spacing-table-column">{{ container.px }}px</label>
            <div class="Styleguide__spacing-table-column Styleguide__spacing-table-column--extralong">
              <label>{{ container.px }}px</label>
              <progress
                class="Styleguide__spacing-table-row-progress Styleguide__spacing-table-row-progress--container"
                :max="containers?.[containers.length - 1]?.px"
                :value="container.px"
              />
            </div>
          </div>
    ...
    <div class="Styleguide__section">
      ...
      <section>
        <template
          ...
          :key="`buttons-${style}`"
        >
          <label class="Styleguide__buttons-subheader subtitle-1 capitalize">{{ style }}</label>
            ...
            >
              ...
              <div class="Styleguide__buttons-buttons mt-6 mb-6">
                <div class="Styleguide__buttons-buttons-example">
                  <label class="Styleguide__buttons-buttons-example-label subtitle-1 mr-3 capitalize">Rest</label>
                  <base-button
                    :icon="'ring'"
                    :size="size"
                    :type="style"
                ...
                <div class="Styleguide__buttons-buttons-example">
                  <label class="Styleguide__buttons-buttons-example-label subtitle-1 mr-3 capitalize">Hover</label>
                  <base-button
                    :icon="'ring'"
                    :size="size"
                    :type="style"
                ...
                <div class="Styleguide__buttons-buttons-example">
                  <label class="Styleguide__buttons-buttons-example-label subtitle-1 mr-3 capitalize">Focused</label>
                  <base-button
                    :icon="'ring'"
                    :size="size"
                    :type="style"
                ...
                <div class="Styleguide__buttons-buttons-example">
                  <label class="Styleguide__buttons-buttons-example-label subtitle-1 mr-3 capitalize">Disabled</label>
                  <base-button
                    :disabled="true"
                    :icon="'ring'"
                    :size="size"
                ...
                <div class="Styleguide__buttons-buttons-example">
                  <label class="Styleguide__buttons-buttons-example-label subtitle-1 mr-3 capitalize">Loading</label>
                  <base-button
                    :icon="'ring'"
                    :loading="true"
                    :size="size"
    ...
    <div class="Styleguide__section">
      ...
      <section>
        <div class="Styleguide__tags">
          <h6 class="mb-20">Invoice tags</h6>
      ...
      <section>
        <div class="Styleguide__tags">
          <h6 class="mb-20">Reserves tags</h6>
      ...
      <section>
        <div class="Styleguide__tags">
          <h6 class="mb-20">Transfers tags</h6>
    ...
    <div class="Styleguide__section">
      ...
      <section>
        <h6 class="mb-20">Light tags (short text)</h6>
        <div class="Styleguide__tooltips">
          <label
            v-for="(tooltip, index) in tooltips"
            :key="`tooltip-${index}`"
            :class="`Styleguide__tooltip tooltip tooltip--light ${tooltip.position}`"
            :data-tooltip="tooltip.text"
            role="tooltip"
          >
            {{ tooltip.text }} on {{ tooltip.position }}
          </label>
        </div>

        <h6 class="mb-20 mt-20">Light tags (long text)</h6>
        <div class="Styleguide__tooltips">
          <label
            v-for="(tooltip, index) in tooltips"
            :key="`tooltip-${index}`"
            :class="`Styleguide__tooltip tooltip tooltip--light ${tooltip.position}`"
            :data-tooltip="`${tooltip.text} ${tooltip.text} ${tooltip.text}`"
            role="tooltip"
          >
            {{ tooltip.text }} on {{ tooltip.position }}
          </label>
        ...
        <h6 class="mb-20 mt-20">Dark tags (short text)</h6>
        <div class="Styleguide__tooltips">
          <label
            v-for="(tooltip, index) in tooltips"
            :key="`tooltip-${index}`"
            :class="`Styleguide__tooltip tooltip tooltip--dark ${tooltip.position}`"
            :data-tooltip="tooltip.text"
            role="tooltip"
          >
            {{ tooltip.text }} on {{ tooltip.position }}
        ...
        <h6 class="mb-20 mt-20">Dark tags (long text)</h6>
        <div class="Styleguide__tooltips">
          <label
            v-for="(tooltip, index) in tooltips"
            :key="`tooltip-${index}`"
...
.Styleguide
  ...
  &__tooltips
    +flex($direction: row, $justify: space-between, $basis: 50%, $wrap: wrap)
